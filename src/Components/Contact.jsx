...
const Contact = () => {
  return (
    <div className='gradient'>
      <h2 className='text-center my-3'> Feel Free To Contact Us </h2>
      <div className="row mt-5">
        ...
        <div className="col-5">
        <form action="https://formspree.io/f/mdorznro" method="POST" >
          <input type="text" className="form-control w-75" placeholder="Enter Your Name" required name="Name" />
